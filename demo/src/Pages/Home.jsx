        ...
        <Row>
          <Col lg="6" md="12">
            <div className="hero__content">
              <div className="hero__subtitle d-flex align-items-center">
                ...
                <img src={worldImg} alt="World" className="ml-3" />
              </div>
              <h1>
                "Explore Jharkhand's Untouched Beauty and{' '}
                <span className="highlight">Vibrant Culture.</span>"
              </h1>
              <p>
          ...
          <Col lg="6" className="d-none d-lg-block">
            <div className="hero__gallery">
              <MasonryImagesGallery images={[
                { src: heroImg, alt: 'Hero Image' },
                { src: heroVideo, alt: 'Hero Video', isVideo: true },
                { src: heroImg02, alt: 'Hero Image 2' },
                { src: './path/to/image4', alt: 'Image 4' },
                { src: './path/to/image5', alt: 'Image 5' }
              ]} />
            </div>
          </Col>
        </Row>
